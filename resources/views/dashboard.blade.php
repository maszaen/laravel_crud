                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full w-full border border-gray-200">
                                <thead class="bg-gray-50 border-b border-gray-200">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase">Nama Produk</th>
                                    ...
                                    @foreach($recentProducts as $product)
                                        <tr class="border-b border-gray-200 last:border-b-0">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <span class="px-2 py-1 text-xs rounded flex items-center justify-center
